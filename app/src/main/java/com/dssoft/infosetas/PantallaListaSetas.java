...
public class PantallaListaSetas extends AppCompatActivity implements AdapterView.OnItemSelectedListener
{
    ...
    private void obtenerListaSetas()
    {
        ...
        do
        {
            ...
            Log.e("Nombre Seta", seta.getNombre());
            Log.e("Nombre Ordenar", seta.getNombre_ordenar());
